...
public class middleAuto extends SequentialCommandGroup {
    ...
    public middleAuto(Swerve s_Swerve, ElevatorSub s_Elevator, ShoulderSub s_Shoulder, WristSub s_Wrist, IntakeSub s_Intake){
        ...
        addCommands(
            ...
            // balance on station
            new InstantCommand(() -> s_Swerve.resetOdometry(balance.getInitialPose())),
