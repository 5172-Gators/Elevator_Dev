...
import frc.robot.LEDConstants.LEDMode;
import frc.robot.subsystems.LEDModes.LEDModeBase;
import frc.robot.subsystems.LEDModes.Flash;
import frc.robot.subsystems.LEDModes.OrangeDot;
import frc.robot.subsystems.LEDModes.Rainbow;
